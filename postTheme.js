...
async function main() {
  ...
  const message = `The monthly photography theme for ${title} is *${theme}*! You have one month to capture some amazing photos and post them in this channel.` // TODO: Update this wording
